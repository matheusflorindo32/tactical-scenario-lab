@props([
    ...
    'description' => 'Plataforma educacional para instrutores de APH configurarem, executarem e debriefarem cenários de treinamento.',
    'current' => null,
])
...
<body class="min-h-full bg-stone-25 antialiased">
    ...
    <div class="tsl-container flex gap-8">
        ...
        <main
            id="main"
            class="min-h-[calc(100vh-4rem)] min-w-0 flex-1 py-8"
        >
            @isset($breadcrumbs)
                <div class="mb-4">
                    {{ $breadcrumbs }}
